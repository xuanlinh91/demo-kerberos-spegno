...
@Service
public class BldgUpdateDispatchServiceImpl implements BldgUpdateDispatchService {
	...
	public List<BldgErrBldgListView> getPageEntries(PaginationCriteria paginationCriteria) {
		...
		var bldgErrItemList = bldgErrService.finBldgErrData(TieUpErrWarnTypeDefinition.OTHER_DISPATCH, order,
				paginationCriteria);
