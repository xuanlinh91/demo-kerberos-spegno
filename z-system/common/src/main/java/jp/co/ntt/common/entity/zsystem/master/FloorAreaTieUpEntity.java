...
@Data
@Entity
@Table(name = "TM_FloorAreaTieUp")
@EntityListeners(AuditingEntityListener.class)
public class FloorAreaTieUpEntity {
	...
	@Column(name = "account_period_month", length = 2)
	private String accountPeriodMonth;

	@Column(name = "account_period_year", length = 4)
	private String accountPeriodYear;

	@Column(name = "building_address_dispatch", length = 255)
	private String buildingAddressDispatch;

	@Column(name = "building_address_floor_area", length = 255)
	private String buildingAddressFloorArea;

	@Column(name = "building_address_origin", length = 255)
	private String buildingAddressOrigin;

	@Column(name = "building_code_dispatch", length = 255)
	private String buildingCodeDispatch;
	...
	@Column(name = "building_name_floor_area", length = 255)
	private String buildingNameFloorArea;
